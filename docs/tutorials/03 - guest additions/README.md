...
Take a note, that we used a new action: [`sleep`](../../reference/Actions.md#sleep). This aciton works exactly how you'd exect it to work: just waits unconditionally for the specified amount of time.
